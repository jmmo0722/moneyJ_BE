...
public class TripPlanService {
    ...
    public TripPlanResponseDTO createTripPlans(TripPlanRequestDTO requestDTO){
        ...
        TripPlan tripPlan = TripPlan.builder()
                ...
                .flight_cost((requestDTO.getFlightCost()))
                .accommodation_cost((requestDTO.getAccommodationCost()))
                .food_cost((requestDTO.getFoodCost()))
                .other_cost((requestDTO.getOtherCost()))
                .currentSavings(0)
